...
- [1] Gu T, Lee PH, Duan R. “COMMUTE: Communication-efficient transfer learning approach for multi-site risk prediction.” [MedRxiv](https://www.medrxiv.org/content/10.1101/2022.03.23.22272834v1) (2022).
- [2] Gu T, Han Y, Duan R. “A transfer learning approach based on random forest with application to breast cancer prediction in underrepresented
    populations.” [Proceedings of Pacific Symposium on Biocomputing (PSB) 2023](https://psb.stanford.edu/callfor/papers/psb23_papers_allv2.pdf) (2022).
- [3] Gu T, Han Y, Duan R. “Robust angle-based transfer learning in high dimensions” [ArXiv](http://arxiv.org/abs/2210.12759) (2022).

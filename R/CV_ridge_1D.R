...
CV_ridge_1D <- function(x_train, y_train, w, rho, var){
  ...
  return(list(mse_1D_best=mse_1D_best, mse_target_best=mse_target_best,beta_1D_best=beta_1D_best, beta_target_best=beta_target_best,lam_1D_best=lam_1D_best, lam_target_best=lam_target_best))
}
